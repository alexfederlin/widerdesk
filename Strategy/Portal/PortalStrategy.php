...
class PortalStrategy extends OpauthStrategy{
    ...
    /**
     * Internal callback, after Portal's OAuth
     */
    public function int_callback(){
        if (array_key_exists('code', $_GET) && !empty($_GET['code'])){
            ...
            if (!empty($results) && !empty($results['access_token'])){
                 ...
                 * - description
                 * - phone: not accessible via Portal Graph API
                 */
    ...
    /**
     * Queries Portal Graph API for user info
     *
